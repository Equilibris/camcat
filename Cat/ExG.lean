...
def nodup [DecidableEq B] {f : A → B} {v}
...
theorem comp_assoc {W X Y Z} (f : Ent W X) (g : Ent X Y) (h : Ent Y Z)
  ...
  ext a b
  constructor
  · simp only [comp_iff_comp', Equiv.toFun_as_coe, Equiv.invFun_as_coe, Equiv.apply_symm_apply]
